  ...
  return (
    <Link href={projectUrl}>
      <motion.div
        ...
        className="cursor-pointer relative flex items-center hover:my-4 justify-center h-auto w-full shadow-xl dark:shadow-[#002A2e] shadow-gray-400 rounded-xl p-4 group hover:bg-[#001B1D]"
      >
        <Image
